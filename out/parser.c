...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FRAG_END = 3,                   /* FRAG_END  */
  YYSYMBOL_FRAGMENT = 4,                   /* FRAGMENT  */
  YYSYMBOL_BR_CLOSE = 5,                   /* BR_CLOSE  */
  YYSYMBOL_INPUT = 6,                      /* INPUT  */
  YYSYMBOL_IN_ACCESS = 7,                  /* IN_ACCESS  */
  YYSYMBOL_CHAR = 8,                       /* CHAR  */
  YYSYMBOL_ARG = 9,                        /* ARG  */
  YYSYMBOL_NEWLINE = 10,                   /* NEWLINE  */
  YYSYMBOL_OUTPUT = 11,                    /* OUTPUT  */
  YYSYMBOL_END = 12,                       /* END  */
  YYSYMBOL_COMM = 13,                      /* COMM  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "FRAG_END", "FRAGMENT",
  "BR_CLOSE", "INPUT", "IN_ACCESS", "CHAR", "ARG", "NEWLINE", "OUTPUT",
  "END", "COMM", "COLOR", "UNKNOWN", "TIMES", "SLASH", "UMINUS", "$accept",
...
{
       2,     0,     0,     3,     4,     0,     5,     6,     7,     8,
       9,    10,    11,    12,     3,     4,     0,     5,     6,     7,
       8,     9,    10,    11,    12,    14,     0,     0,     0,     0,
      15
};
